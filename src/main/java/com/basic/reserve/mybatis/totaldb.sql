...
VALUES
('test1.jpg', '콘서트', '공연', '아이유 콘서트', '2022-05-01', '2022-05-03', '아이유의 새로운 앨범 라이브 공연', '서울 예술의전당', '1시간30분', 100, 50000, 45000, 4),
('test2.jpg', '뮤지컬', '공연', '레미제라블', '2022-06-01', '2022-06-10', '빅토르 위고의 역사적인 이야기를 담은 뮤지컬', '씨어터 삼각지', '2시간30분', 200, 80000, 70000, 4.5),
('test3.jpg', '영화', '영화', '빈센트 반 고흐 전시', '2022-07-01', '2022-07-30', '세계적인 화가 빈센트 반 고흐의 대표작품들이 전시됩니다', '국립 현대미술관', '6시간30분', 50, 30000, 25000, 3.5),
('test4.jpg', '야구', '스포츠', '한화 이글스 경기', '2022-04-01', '2022-04-05', '한화 이글스의 홈 경기를 관람하세요', '인천 SK 행복드림구장', '2시간30분', 300, 25000, 20000, 4),
('test5.jpg', '연극', '공연', '하이큐!!', '2022-08-01', '2022-08-15', '인기 만화 하이큐!!를 연극으로 재현한 공연', '대학로 소극장', '1시간30분', 100, 40000, 35000, 4.5);

--#################### set sport dummy data ; ###################

INSERT INTO ticket (image, Contents, Category, Title, DateStart, DateEnd, Info, Location, Duration, SeatNum, Price, Discount, Star)
VALUES
('sports1.jpg', '야구', '스포츠', '두산 vs kt', '2023-03-24', '2023-03-24', '두산과 KT의 개막전 시범경기를 선보입니다.', '잠실 야구경기장', '2시간30분', 100, 30000, 5, 4.5),
('sports2.jpg', '야구', '스포츠', 'KT wiz 시범경기', '2023-01-14', '2023-01-14', 'KT WIZ의 개막전 시범경기를 선보입니다.', '목동 야구경기장', '2시간30분', 100, 30000, 5, 3.5),
('sports3.jpg', '야구', '스포츠', '한화 vs 삼성', '2023-03-24', '2023-03-24', '삼성과 한화의 개막전 시범경기를 선보입니다.', '잠실 야구경기장', '2시간30분', 100, 30000, 5, 4),
('sports4.jpg', '축구', '스포츠', 'FC 서울 vs 수원 삼성', '2023-04-02', '2023-04-02', 'K리그 개막전 FC 서울과 수원 삼성의 경기를 선보입니다.', '상암월드컵경기장', '2시간30분', 100, 40000, 10, 4.2),
('sports5.jpg', '야구', '스포츠', '롯데 자이언츠 시범경기', '2023-03-30', '2023-03-30', '롯데 자이언츠의 개막전 시범경기를 선보입니다.', '사직야구장', '2시간30분', 100, 25000, 5, 4.7),
('sports6.jpg', '테니스', '스포츠', '제주컵 테니스 대회', '2023-06-01', '2023-06-05', '국내 최고의 테니스 대회인 제주컵이 시작됩니다.', '제주시청 테니스장', '2시간30분', 200, 50000, 15, 4.9),
