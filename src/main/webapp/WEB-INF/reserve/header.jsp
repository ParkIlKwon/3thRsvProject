...
<nav class="navbar navbar-expand-md navbar-light px-2" id="topNv" style="background-color:none;">
...
<nav class="navbar navbar-expand-md navbar-light" style="background-color:#f9e7cb;">
<div class="container-fluid">
