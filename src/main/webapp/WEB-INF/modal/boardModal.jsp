  ...
  <div class="modal-dialog">
    <div class="modal-content">
				...
				<div class="col" style="border: 2px solid #f9e7cb; border-radius: 5px">
					<div class="row p-3 pb-0">
						...
						<div class="col ps-0 pe-3">
							<input class="input-basic col-12" type="text" id="writer" />
						</div>
					</div>
					<hr class="text-basic">
					<div class="row p-3 pt-0">
						...
						<div class="col ps-0 pe-3">
							<textarea class="input-basic col-12" id="contents" rows="10"></textarea>
						</div>
					</div>
				</div>
			</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn-basic" data-bs-dismiss="modal" onclick="#">등록</button>
