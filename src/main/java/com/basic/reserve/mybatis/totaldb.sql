...
VALUES
('test1.jpg', '콘서트', '공연', '아이유 콘서트', '2023-05-01', '2023-05-03', '아이유의 새로운 앨범 라이브 공연', '서울 예술의전당', '1시간30분', 100, 50000, 4, 4),
('test2.jpg', '뮤지컬', '공연', '레미제라블', '2023-06-01', '2023-06-10', '빅토르 위고의 역사적인 이야기를 담은 뮤지컬', '씨어터 삼각지', '2시간30분', 200, 80000, 7, 4.5),
('test3.jpg', '영화', '영화', '빈센트 반 고흐 전시', '2023-03-20', '2023-3-30', '세계적인 화가 빈센트 반 고흐의 대표작품들이 전시됩니다', '국립 현대미술관', '6시간30분', 50, 30000, 25, 3.5),
('test4.jpg', '야구', '스포츠', '한화 이글스 경기', '2023-04-01', '2023-04-05', '한화 이글스의 홈 경기를 관람하세요', '인천 SK 행복드림구장', '2시간30분', 300, 25000, 20, 4),
('test5.jpg', '연극', '공연', '하이큐!!', '2023-03-01', '2023-03-15', '인기 만화 하이큐!!를 연극으로 재현한 공연', '대학로 소극장', '1시간30분', 100, 40000, 5, 4.5);
